...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Performance", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>Performance</b> version", Q_NULLPTR));
...
"Copyright \302\251 2017 The Performance Developers", Q_NULLPTR));
