...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "Performance - Debug window", Q_NULLPTR));
        label_9->setText(QApplication::translate("RPCConsole", "Performance Core", Q_NULLPTR));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Performance debug log file from the current data directory. This can take a few seconds for large log files.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the Performance-Qt help message to get a list with possible Performance command-line options.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
