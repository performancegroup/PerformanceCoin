...
const string strMessageMagic = "Performance Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    if (IsProofOfStake())
    {
        ...
        int64_t nCalculatedStakeReward = GetProofOfStakeReward(pindex->nHeight, pindex->pprev, nCoinAge, nFees);
...
{
    RenameThread("Performance-loadblk");
