...
private slots:
    ...
    QString BuyPRFM(QString OrderType, double Quantity, double Rate);
    QString SellPRFM(QString OrderType, double Quantity, double Rate);
