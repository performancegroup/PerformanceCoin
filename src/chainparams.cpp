...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "Performance starts 12 Apr 2018";
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        CTransaction txNew(1, 1524177000, vin, vout, 0);
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1524177000; //GMT: Thu, 12 Apr 2018 13:00:00 GMT
        genesis.nBits    = 0x1f60d2d1;//0x1f00ffff;
        genesis.nNonce   = 38601;
        ...
        LogPrintStr(genesis.ToString());
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x96caeb00c45d955c4cfb2da91a8523387751b552dc68490d4b563b97f59bca88"));
        assert(genesis.hashMerkleRoot == uint256("0x016a89e2c8589cb29ee906a21b70c0d7e61784028c421825e76d9d87bdad1348"));
...
//        vSeeds.push_back(CDNSSeedData("0",  "206.189.30.4"));
//        vSeeds.push_back(CDNSSeedData("1",  "159.65.30.39"));
//        vSeeds.push_back(CDNSSeedData("2",  "159.89.90.205"));
//        vSeeds.push_back(CDNSSeedData("3",  "206.189.76.39"));
        convertSeeds(vFixedSeeds, pnSeed, ARRAYLEN(pnSeed), nDefaultPort);

        nPoolMaxTransactions = 3;
        //strSporkKey = "046f78dcf911fbd61910136f7f0f8d90578f68d0b3ac973b5040fb7afb501b5939f39b108b0569dca71488f5bbf498d92e4d1194f6f941307ffd95f75e76869f0e";
        //strMasternodePaymentsPubKey = "046f78dcf911fbd61910136f7f0f8d90578f68d0b3ac973b5040fb7afb501b5939f39b108b0569dca71488f5bbf498d92e4d1194f6f941307ffd95f75e76869f0e";
        strDarksendPoolDummyAddress = "QZYjCQxL3Gs1anGKMRGF7g3ShZUdWs4G3Y";
        nLastPOWBlock = 50;
        nPOSStartBlock = 10;
    }
